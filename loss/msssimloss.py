...
if __name__=='__main__':
    ...
    import cv2
    npImg1 = cv2.imread("E://pytorch/c2/datasets/sots/trainA/1040_1_0.2.jpg")
...
########################  SSIM ######################
    ...
    #
    ssim_loss = SSIM()
    ssim_value = ssim_loss(img1, img1)
...
########################  MS_SSIM ######################
    ...
    ms_ssim_value = ms_ssim_loss(img1, img1).data
    print("Initial ms_ssim:", ms_ssim_value)
